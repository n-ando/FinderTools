# config.sh — single source of truth for the Shlink build.
#
...
# Appearance variants to produce. Each becomes a Shlink_<variant>.app.
...
SRC_DIR="src"
ICON_SRC_DIR="${SRC_DIR}/icon"          # Shlink.svg + <variant>/{icon.json,master_1024.png}
...
APPS_OUT="${BUILD_DIR}/apps"            # final Shlink_<variant>.app
