# config.sh — single source of truth for the NewMD build.
#
...
APP_NAME="NewTerminal"

# Appearance variants to produce. Each becomes a NewMD_<variant>.app.
...
SRC_DIR="src"
ICON_SRC_DIR="${SRC_DIR}/icon"          # NewMD.svg + <variant>/{icon.json,master_1024.png}
...
APPS_OUT="${BUILD_DIR}/apps"            # final NewMD_<variant>.app
